...
@section('body')
    <div class="bg-blue-500 h-screen w-3/12 p-3 absolute">
        ...
        <form action="{{ route('saveItem') }}" method="post">
            ...
            <input class="mx-auto mb-3 p-1 rounded w-full" type="date" name="deadline" id="deadline" required>
